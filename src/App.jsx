			...
			<div className="z-bg-blue">
				<div className="flex">
					...
					<div className="flex flex-col">
						<main
							className={'w-11/12 md:w-9/12 mx-auto text-white '}>
							...
							<section className="my-4">
								...
								<p className="text-justify">
									A skilled professional, bringing a strong
									work ethic, web development expertise, and
									simple yet creative solutions to technical
									problems. Eager to join the workforce, I am
									ready to hit the ground running and apply
									myself to the job to the best of my ability.
									My goal is to put my knowledge, skills and
									understanding to good use and provide
									remarkable service to the organization.
								</p>
							</section>
									...
									<div className="flex">
										...
										<div className="">
											...
											<div className="text-justify">
												<p>
													Developed microservices to
													break down a currently
													existing monolithic
													software.
												</p>
												<p>
													Led the creation of various
													REST APIs that interfaced
										...
										<div className="">
											...
											<div className="text-justify">
												...
												<p>
													...
													the GetBotty project:
													Stripe, PayMaya, GrabPay
												</p>
												<p>
