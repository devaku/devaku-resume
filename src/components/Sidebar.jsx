...
export default function Sidebar({ showSidebar, setShowSidebar }) {
	...
	return (
		<div
			className={
				'absolute sm:fixed flex flex-col justify-evenly w-full sm:w-2/12 h-full z-bg-blue-dark z-10 sm:translate-x-0 sidebar ' +
			...
			<div onClick={handleClickProfilePicture} className="grow sm:grow-0">
				<div className="flex justify-center">
					<img
						className={'w-6/12 ' + (displaySpyro ? 'hidden' : '')}
						src={profilePicture}
						alt="Profile Picture"
					/>
					<img
